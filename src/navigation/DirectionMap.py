...
class DirectionMap:
    ...
    def __init__(self, direction_map):
        self.direction_map = direction_map

    def get_next_desired_location(self, current_pos):
        (current_x, current_y) = current_pos
        return self.direction_map[current_x][current_y]

    def get_desired__direction(self, current_pos):
        return self.get_next_desired_location(current_pos) - current_pos

    def get_desired_step_size(self, current_pos):
    ...
    def get_desired__direction_angle(self, current_pos):
        # y/x=tg
        # alpha=arctan(y/x)
